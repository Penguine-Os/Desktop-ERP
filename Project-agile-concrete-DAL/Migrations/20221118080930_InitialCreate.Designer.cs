...
namespace Project_agile_concrete_DAL.Migrations
{
    ...
    [Migration("20221118080930_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project_agile_concrete_models.KlantFactuur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Project_agile_concrete_models.KlantFactuur", b =>
                {
                    b.HasOne("Project_agile_concrete_models.Factuur", "Factuur")
                        .WithOne("Klant")
                        .HasForeignKey("Project_agile_concrete_models.KlantFactuur", "FactuurId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
